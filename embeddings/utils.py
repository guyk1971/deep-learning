...
def create_lookup_tables(words):
    ...
    int_to_vocab = {ii: word for ii, word in enumerate(sorted_vocab)}   # enumerate the words in sorted vocab
    vocab_to_int = {word: ii for ii, word in int_to_vocab.items()}  # inverse mapping
