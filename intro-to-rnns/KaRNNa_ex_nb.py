# python file to accompany the Anna_KaRNNa_Exercise notebook
import time
...
def build_loss(logits, targets, lstm_size, num_classes):
    ...
    y_reshaped = tf.reshape(y_one_hot, [-1, logits.get_shape()])
...
class CharRNN:
    def __init__(self, num_classes, batch_size=64, num_steps=50,
        ...
        self.inputs, self.targets, self.keep_prob = build_inputs(batch_size,num_steps=num_steps)
        ...
        outputs, state = tf.nn.dynamic_rnn(cell,x_one_hot,sequence_length=num_steps,initial_state=self.initial_state)
        ...
        self.loss = build_loss(self.logits,self.targets,lstm_size=lstm_size,num_classes=num_classes)
        self.optimizer = build_optimizer(self.loss,learning_rate=learning_rate,grad_clip=grad_clip)
