...
targets_ = tf.placeholder(tf.float32,shape=[None,28,28,1],name='inputs')
...
# Now 7x7x8
encoded = tf.layers.max_pooling2d(conv3,(2,2),(2,2),padding='same')        # no activation in this layer
# Now 4x4x8
...
# very similar to the conv autoencoder only that the input is augmented with noise while training.
# the capacity of the network is increased vs the simple autoencoder
tf.reset_default_graph()
learning_rate = 0.001
