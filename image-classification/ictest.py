...
def conv2d_maxpool(x_tensor, conv_num_outputs, conv_ksize, conv_strides, pool_ksize, pool_strides):
    ...
    """
    # TODO: Implement Function
#    fan_in= np.prod(conv_ksize)*x_tensor.shape.as_list()[3]     # the number of input weights
#    W = tf.Variable(tf.truncated_normal(list(conv_ksize) + [x_tensor.shape.as_list()[3], conv_num_outputs], stddev=1.0/np.sqrt(fan_in)),name='conv_weights')
...
#    fan_in=n_features
#    W = tf.Variable(tf.truncated_normal([n_features,num_outputs],stddev=1.0/np.sqrt(fan_in)),name='fc_weights')
...
def output(x_tensor, num_outputs):
    ...
    n_features=x_tensor.shape.as_list()[1]
#    fan_in=n_features
#    W = tf.Variable(tf.truncated_normal([n_features,num_outputs],stddev=1.0/np.sqrt(fan_in)),name='out_weights')
